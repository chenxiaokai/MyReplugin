 ...
 *
 * 生成RepluginHostConfig.java 位于
 * E:\github\RePlugin-2.2.0\replugin-sample\host\app\build\generated\source\buildConfig\baidu\release\com\qihoo360\replugin\gen\RePluginHostConfig.java
 */
public class RePluginHostConfigCreator implements IFileCreator {
    ...
    def RePluginHostConfigCreator(def project, def variant, def cfg) {
        ...
        //buildConfigGeneratedDir = E:\github\RePlugin-2.2.0\replugin-sample\host\app\build\generated\source\buildConfig\baidu\release
        File buildConfigGeneratedDir = this.variant.getVariantData().getScope().getBuildConfigSourceOutputDir()
        fileName = HOST_CONFIG_NAME;
        // HOST_CONFIG_PATH =   \com\qihoo360\replugin\gen\
    ...
    @Override
    File getFileDir() {
        // E:\github\RePlugin-2.2.0\replugin-sample\host\app\build\generated\source\buildConfig\baidu\release\com\qihoo360\replugin\gen\
        fileDir
    }
