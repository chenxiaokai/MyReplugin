...
public class FileCreators {
    ...
    static def create(IFileCreator creator) {
        ...
        //creator.getFileNanme()  RePluginHostConfig.java
        ...
        //< replugin-host-v2.2.0 > rewrite E:\github\RePlugin-2.2.0\replugin-sample\host\app\build\generated\source\buildConfig\baidu\release\com\qihoo360\replugin\gen\RePluginHostConfig.java
        //< replugin-host-v2.2.0 > rewrite E:\github\RePlugin-2.2.0\replugin-sample\host\app\build\intermediates\assets\baidu\release\plugins-builtin.json
