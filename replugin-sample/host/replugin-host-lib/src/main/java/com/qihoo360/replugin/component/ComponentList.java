...
public class ComponentList {
     ...
     * 注意：仅框架内部使用
     */
    public ComponentList(PackageInfo pi, String path, PluginInfo pli) { // 四大组件 全部是插件中的组件
        if (pi.activities != null) {
            for (ActivityInfo ai : pi.activities) {
                if (LOG) {
                    // 打开插件demo1
                    // activity=com.qihoo360.replugin.sample.demo1.MainActivity
                    // activity=com.qihoo360.replugin.sample.demo1.activity.standard.StandardActivity
                    // activity=com.qihoo360.replugin.sample.demo1.activity.theme.ThemeBlackNoTitleBarActivity
                    // activity=com.qihoo360.replugin.sample.demo1.activity.theme.ThemeDialogActivity
                    // activity=com.qihoo360.replugin.sample.demo1.activity.theme.ThemeBlackNoTitleBarFullscreenActivity
                    // activity=com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity1
                    // activity=com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity2
                    // activity=com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity3
                    // activity=com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity4
                    // activity=com.qihoo360.replugin.sample.demo1.activity.single_instance.TIActivity1
                    // activity=com.qihoo360.replugin.sample.demo1.activity.single_top.SingleTopActivity1
                    // activity=com.qihoo360.replugin.sample.demo1.activity.intent_filter.IntentFilterDemoActivity1
                    // activity=com.qihoo360.replugin.sample.demo1.activity.for_result.ForResultActivity
                    // activity=com.qihoo360.replugin.sample.library.LibMainActivity
        ...
        if (pi.providers != null) {
            for (ProviderInfo ppi : pi.providers) {
                if (LOG) {
                    // provider=com.qihoo360.replugin.sample.demo1.provider.Provider2; auth=com.qihoo360.replugin.sample.demo1.provider2
        ...
        if (pi.services != null) {
            for (ServiceInfo si : pi.services) {
                if (LOG) {
                    // service=com.qihoo360.replugin.sample.demo1.service.PluginDemoAppService
                    //  service=com.qihoo360.replugin.sample.demo1.service.PluginDemoService1
        ...
        if (pi.receivers != null) {
            for (ActivityInfo ri : pi.receivers) {
                if (LOG) {
                    // receiver=com.qihoo360.replugin.sample.demo1.receivers.PluginDemo1Receiver
        ...
        if (LOG) {
            /*
             解析插件 demo1 : /data/user/0/com.qihoo360.replugin.sample.host/app_plugins_v3/demo1-10-10-104.jar
             AndroidManifest:
             <?xml version="1.0" encoding="utf-8"?>
             <manifest xmlns:android="http://schemas.android.com/apk/res/android" android:versionCode="null" android:versionName="1.1" package="com.qihoo360.replugin.sample.demo1" platformBuildVersionCode="25" platformBuildVersionName="7.1.1">
             <uses-sdk android:minSdkVersion="null" android:targetSdkVersion="null" />
             <uses-permission android:name="android.permission.WRITE_EXTERNAL_STORAGE" />
             <uses-permission android:name="android.permission.READ_PHONE_STATE" />
             <uses-permission android:name="android.permission.READ_EXTERNAL_STORAGE" />
             <application android:label="null" android:icon="null" android:name="com.qihoo360.replugin.sample.demo1.MainApp" android:debuggable="null" android:allowBackup="null" android:supportsRtl="null">
             <meta-data android:name="process_map" android:value="[             {&apos;from&apos;:&apos;com.qihoo360.replugin.sample.demo1:bg&apos;,&apos;to&apos;:&apos;$p0&apos;}             ]" />
             <activity android:name="com.qihoo360.replugin.sample.demo1.MainActivity" android:exported="null" android:screenOrientation="null" android:configChanges="null">
             <intent-filter>
             <action android:name="android.intent.action.MAIN" />
             <category android:name="android.intent.category.LAUNCHER" />
             </intent-filter>
             </activity>
             <activity android:name="com.qihoo360.replugin.sample.demo1.activity.standard.StandardActivity" android:exported="null" android:screenOrientation="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.theme.ThemeBlackNoTitleBarActivity" android:exported="null" android:launchMode="null" android:screenOrientation="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.theme.ThemeDialogActivity" android:exported="null" android:screenOrientation="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.theme.ThemeBlackNoTitleBarFullscreenActivity" android:screenOrientation="null">
             <intent-filter>
             ...
             <receiver android:name="com.qihoo360.replugin.sample.demo1.receivers.PluginDemo1Receiver">
             <intent-filter>
             <action android:name="com.qihoo360.repluginapp.replugin.receiver.ACTION1" />
             </intent-filter>
             </receiver>
             <service android:name="com.qihoo360.replugin.sample.demo1.service.PluginDemoAppService" />
             <service android:name="com.qihoo360.replugin.sample.demo1.service.PluginDemoService1" android:process=":bg" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity1" android:taskAffinity=":ta_1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity2" android:taskAffinity=":ta_1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity3" android:taskAffinity=":ta_1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.task_affinity.TAActivity4" android:taskAffinity=":ta_1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.single_instance.TIActivity1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.single_top.SingleTopActivity1" android:launchMode="null" />
             <activity android:theme="null" android:name="com.qihoo360.replugin.sample.demo1.activity.intent_filter.IntentFilterDemoActivity1">
             <intent-filter>
        ...
        if (LOG) {
            // mApplication: ApplicationInfo{c67e2c1 com.qihoo360.replugin.sample.demo1}
