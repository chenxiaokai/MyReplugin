...
public class ProcessPitProviderBase extends ContentProvider {
    ...
    public static final Uri buildUri(int index) {
        ...
        str += index;
        //Uri最终会是这样的：content://com.qihoo360.replugin.sample.host.loader.p.mainN99/main，
        // 中间的com.qihoo360.replugin.sample.host.loader.p.mainN99是ContentProvider的authority 这个是在 gradle编译的时候 插入到宿主的manifest文件中去
