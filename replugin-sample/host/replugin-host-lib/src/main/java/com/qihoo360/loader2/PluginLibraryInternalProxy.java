...
public class PluginLibraryInternalProxy {
    ...
    public boolean startActivity(Context context, Intent intent, String plugin, String activity, int process, boolean download) {
        if (LOG) {
            // 启动demo1 的 MainActivity
            // start activity: intent=Intent { cmp=com.qihoo360.replugin.sample.demo1/.MainActivity } plugin=com.qihoo360.replugin.sample.demo1 activity=com.qihoo360.replugin.sample.demo1.MainActivity process=-2147483648 download=true
        ...
        if (LOG) {
            // 启动demo1 的 MainActivity
            // isHookingClass(com.qihoo360.replugin.sample.demo1 , com.qihoo360.replugin.sample.demo1.MainActivity) = false
        ...
        //加载Activity的逻辑在 loadPluginActivity
        ...
        if (LOG) {
            //start activity: real intent=Intent { cat=[process:-2147483648,plugin:com.qihoo360.replugin.sample.demo1,activity:com.qihoo360.replugin.sample.demo1.MainActivity,container:com.qihoo360.replugin.sample.host.loader.a.ActivityN1NRNTS2,counter:0] cmp=com.qihoo360.replugin.sample.host/.loader.a.ActivityN1NRNTS2 (has extras) }
            // start activity: real intent=Intent { cat=[process:-2147483648,plugin:com.qihoo360.replugin.sample.demo1,activity:com.qihoo360.replugin.sample.demo1.activity.standard.StandardActivity,container:com.qihoo360.replugin.sample.host.loader.a.ActivityN1NRNTS4,counter:0] cmp=com.qihoo360.replugin.sample.host/.loader.a.ActivityN1NRNTS4 (has extras) }
            // start activity: real intent=Intent { cat=[activity:com.qihoo360.replugin.sample.demo1.activity.single_top.SingleTopActivity1,process:-2147483648,plugin:com.qihoo360.replugin.sample.demo1,container:com.qihoo360.replugin.sample.host.loader.a.ActivityN1STPNTS1,counter:0] cmp=com.qihoo360.replugin.sample.host/.loader.a.ActivityN1STPNTS1 (has extras) }
