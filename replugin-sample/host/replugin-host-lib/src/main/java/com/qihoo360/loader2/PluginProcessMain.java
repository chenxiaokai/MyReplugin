...
//            }
    ...
    static final void connectToHostSvc() {
        ...
        //获取与Persistent进程通信的IBinder对象,是通过ContentProvider是获取的IBinder对象在ProcessPitProviderPersist中，ProcessPitProviderPersist又在GuardService 进程中
        //所以就会启动GuardService 进程
