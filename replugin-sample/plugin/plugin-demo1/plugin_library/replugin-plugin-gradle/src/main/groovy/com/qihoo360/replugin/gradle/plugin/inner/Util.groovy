...
public class Util {
    ...
    def private static getProjectClassPath(Project project,
        ...
        //projectDir = E:\github\RePlugin-2.2.0\replugin-sample\plugin\plugin-demo1
        ...
        inputs.each { TransformInput input ->
            ...
            input.directoryInputs.each { DirectoryInput dirInput ->
                //E:\github\RePlugin-2.2.0\replugin-sample\plugin\plugin-demo1\app\build\intermediates\transforms\__ReClass__\release 遍历下面所有的文件
                def dir = dirInput.file.absolutePath
                classPath << dir

                visitor.setBaseDir(dir)
                //http://blog.csdn.net/lirx_tech/article/details/51424569
                //walkFileTree 实现文件遍历，第一个参数表示从 什么目录开始遍历
            ...
            input.jarInputs.each { JarInput jarInput ->
                ...
                if (!jarPath.contains(projectDir)) {
                    ...
                    //解压 jarPath 到 目录 jarZipDir
                    if (unzip(jarPath, jarZipDir)) {
                        def jarZip = jarZipDir + ".jar"
                        includeJars << jarPath   //往Set集合中添加元素
                        classPath << jarZipDir
